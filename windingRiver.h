...
const int wr_melody[] PROGMEM = {
  E4, G4, NOTE_A4, B4, NOTE_A4, 0, 
  B4, NOTE_A4, G4, FS4, B3, FS4, 0,
  E4, G4, NOTE_A4, B4, NOTE_A4, 0,
  B4, NOTE_A4, G4, FS4, FS4, D5, D5, 0,
  E5, D5, B4, E4, B4, 0,
  NOTE_A4, G4, FS4, D4, B3, FS4, FS4, 0,
  E4, G4, NOTE_A4, B4, NOTE_A4, 0,
  B4, NOTE_A4, FS4, D4, E4
};

const double wr_noteDurations[] PROGMEM = {
  2, 2, 1.33, 4, 1, 2,
  4, 4, 2, 2, 1.33, 0.8, 1,
  2, 2, 1.33, 4, 1, 2,
  4, 4, 2, 2, 1.33, 4, 1, 1,
